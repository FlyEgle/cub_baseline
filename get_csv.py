...
for i in tqdm(range(4)):
    ...
    # with open("/data/remote/yy_git_code/cub_baseline/logits/20201016/r50_448_cosinelr_logits.log", "a") as file:
    #     for data in tqdm(logits_result):
    #         file.write(json.dumps(data) + '\n')
        
    with open("/data/remote/yy_git_code/cub_baseline/logits/20201016/efnetb5_456_cosinelr_logits.csv", "a") as csvfile:
